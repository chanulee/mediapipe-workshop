...
// Name → index maps for the "named only" debug overlay.
// (478 face landmarks is a lot; these are the ones we've labelled by hand.)
export const FACE_NAMED = {
  NOSE_TIP, FOREHEAD, CHIN,
  LEFT_EYE, RIGHT_EYE, LEFT_EYE_INNER, RIGHT_EYE_INNER,
...
export const HAND_NAMED = {
  WRIST,
  THUMB_CMC, THUMB_MCP, THUMB_IP, THUMB_TIP,
  INDEX_KNUCKLE, INDEX_MID, INDEX_DIP, INDEX_TIP,
  MIDDLE_KNUCKLE, MIDDLE_MID, MIDDLE_DIP, MIDDLE_TIP,
  RING_KNUCKLE, RING_MID, RING_DIP, RING_TIP,
  PINKY_KNUCKLE, PINKY_MID, PINKY_DIP, PINKY_TIP,
};
